...
static const _GripperState_type_support_symbol_names_t _GripperState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, alicia_d_control_interfaces, msg, GripperState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, alicia_d_control_interfaces, msg, GripperState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, alicia_d_control_interfaces, msg, GripperState)() {
  return &::alicia_d_control_interfaces::msg::rosidl_typesupport_c::GripperState_message_type_support_handle;
}
