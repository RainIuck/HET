...
alicia_d_control_interfaces__action__MoveArmToJoints_Goal__init(alicia_d_control_interfaces__action__MoveArmToJoints_Goal * msg)
{
  ...
  if (!rosidl_runtime_c__String__Sequence__init(&msg->joint_names, 0)) {
    alicia_d_control_interfaces__action__MoveArmToJoints_Goal__fini(msg);
    return false;
  }
  // joint_positions
...
alicia_d_control_interfaces__action__MoveArmToJoints_Goal__create()
{
  ...
  alicia_d_control_interfaces__action__MoveArmToJoints_Goal * msg = (alicia_d_control_interfaces__action__MoveArmToJoints_Goal *)allocator.allocate(sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_Goal));
  bool success = alicia_d_control_interfaces__action__MoveArmToJoints_Goal__init(msg);
  if (!success) {
...
alicia_d_control_interfaces__action__MoveArmToJoints_Goal__Sequence__init(alicia_d_control_interfaces__action__MoveArmToJoints_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_Goal * data = NULL;

  if (size) {
    data = (alicia_d_control_interfaces__action__MoveArmToJoints_Goal *)allocator.zero_allocate(size, sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = alicia_d_control_interfaces__action__MoveArmToJoints_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        alicia_d_control_interfaces__action__MoveArmToJoints_Goal__fini(&data[i - 1]);
      }
...
alicia_d_control_interfaces__action__MoveArmToJoints_Goal__Sequence__fini(alicia_d_control_interfaces__action__MoveArmToJoints_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      alicia_d_control_interfaces__action__MoveArmToJoints_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_Goal__Sequence * array = (alicia_d_control_interfaces__action__MoveArmToJoints_Goal__Sequence *)allocator.allocate(sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = alicia_d_control_interfaces__action__MoveArmToJoints_Goal__Sequence__init(array, size);
  if (!success) {
...
alicia_d_control_interfaces__action__MoveArmToJoints_Goal__Sequence__destroy(alicia_d_control_interfaces__action__MoveArmToJoints_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    alicia_d_control_interfaces__action__MoveArmToJoints_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
alicia_d_control_interfaces__action__MoveArmToJoints_Goal__Sequence__are_equal(const alicia_d_control_interfaces__action__MoveArmToJoints_Goal__Sequence * lhs, const alicia_d_control_interfaces__action__MoveArmToJoints_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!alicia_d_control_interfaces__action__MoveArmToJoints_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  alicia_d_control_interfaces__action__MoveArmToJoints_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    alicia_d_control_interfaces__action__MoveArmToJoints_Goal * data =
      (alicia_d_control_interfaces__action__MoveArmToJoints_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!alicia_d_control_interfaces__action__MoveArmToJoints_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          alicia_d_control_interfaces__action__MoveArmToJoints_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!alicia_d_control_interfaces__action__MoveArmToJoints_Goal__copy(
...
alicia_d_control_interfaces__action__MoveArmToJoints_Result__init(alicia_d_control_interfaces__action__MoveArmToJoints_Result * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    alicia_d_control_interfaces__action__MoveArmToJoints_Result__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_Result * msg = (alicia_d_control_interfaces__action__MoveArmToJoints_Result *)allocator.allocate(sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_Result));
  bool success = alicia_d_control_interfaces__action__MoveArmToJoints_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
alicia_d_control_interfaces__action__MoveArmToJoints_Result__Sequence__init(alicia_d_control_interfaces__action__MoveArmToJoints_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_Result * data = NULL;

  if (size) {
    data = (alicia_d_control_interfaces__action__MoveArmToJoints_Result *)allocator.zero_allocate(size, sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = alicia_d_control_interfaces__action__MoveArmToJoints_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        alicia_d_control_interfaces__action__MoveArmToJoints_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
alicia_d_control_interfaces__action__MoveArmToJoints_Result__Sequence__fini(alicia_d_control_interfaces__action__MoveArmToJoints_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      alicia_d_control_interfaces__action__MoveArmToJoints_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_Result__Sequence * array = (alicia_d_control_interfaces__action__MoveArmToJoints_Result__Sequence *)allocator.allocate(sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = alicia_d_control_interfaces__action__MoveArmToJoints_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
alicia_d_control_interfaces__action__MoveArmToJoints_Result__Sequence__destroy(alicia_d_control_interfaces__action__MoveArmToJoints_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    alicia_d_control_interfaces__action__MoveArmToJoints_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
alicia_d_control_interfaces__action__MoveArmToJoints_Result__Sequence__are_equal(const alicia_d_control_interfaces__action__MoveArmToJoints_Result__Sequence * lhs, const alicia_d_control_interfaces__action__MoveArmToJoints_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!alicia_d_control_interfaces__action__MoveArmToJoints_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  alicia_d_control_interfaces__action__MoveArmToJoints_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    alicia_d_control_interfaces__action__MoveArmToJoints_Result * data =
      (alicia_d_control_interfaces__action__MoveArmToJoints_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!alicia_d_control_interfaces__action__MoveArmToJoints_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          alicia_d_control_interfaces__action__MoveArmToJoints_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!alicia_d_control_interfaces__action__MoveArmToJoints_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__init(alicia_d_control_interfaces__action__MoveArmToJoints_Feedback * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->stage)) {
    alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_Feedback * msg = (alicia_d_control_interfaces__action__MoveArmToJoints_Feedback *)allocator.allocate(sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_Feedback));
  bool success = alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__Sequence__init(alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_Feedback * data = NULL;

  if (size) {
    data = (alicia_d_control_interfaces__action__MoveArmToJoints_Feedback *)allocator.zero_allocate(size, sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__Sequence__fini(alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__Sequence * array = (alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__Sequence *)allocator.allocate(sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__Sequence__destroy(alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__Sequence__are_equal(const alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__Sequence * lhs, const alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    alicia_d_control_interfaces__action__MoveArmToJoints_Feedback * data =
      (alicia_d_control_interfaces__action__MoveArmToJoints_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__init(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!alicia_d_control_interfaces__action__MoveArmToJoints_Goal__init(&msg->goal)) {
    alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__fini(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request * msg)
{
  ...
  // goal
  alicia_d_control_interfaces__action__MoveArmToJoints_Goal__fini(&msg->goal);
}
...
alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__are_equal(const alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request * lhs, const alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!alicia_d_control_interfaces__action__MoveArmToJoints_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request * msg = (alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request *)allocator.allocate(sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request));
  bool success = alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__Sequence__init(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request * data = NULL;

  if (size) {
    data = (alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request *)allocator.zero_allocate(size, sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__Sequence__fini(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__Sequence * array = (alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__Sequence *)allocator.allocate(sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__Sequence__destroy(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__Sequence__are_equal(const alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__Sequence * lhs, const alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request * data =
      (alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__init(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response * msg = (alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response *)allocator.allocate(sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response));
  bool success = alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__Sequence__init(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response * data = NULL;

  if (size) {
    data = (alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response *)allocator.zero_allocate(size, sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__Sequence__fini(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__Sequence * array = (alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__Sequence *)allocator.allocate(sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__Sequence__destroy(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__Sequence__are_equal(const alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__Sequence * lhs, const alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response * data =
      (alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!alicia_d_control_interfaces__action__MoveArmToJoints_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__init(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request * msg = (alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request *)allocator.allocate(sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request));
  bool success = alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__Sequence__init(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request * data = NULL;

  if (size) {
    data = (alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request *)allocator.zero_allocate(size, sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__Sequence__fini(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__Sequence * array = (alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__Sequence *)allocator.allocate(sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__Sequence__destroy(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__Sequence__are_equal(const alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__Sequence * lhs, const alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request * data =
      (alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__init(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!alicia_d_control_interfaces__action__MoveArmToJoints_Result__init(&msg->result)) {
    alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__fini(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response * msg)
{
  ...
  // status
  // result
  alicia_d_control_interfaces__action__MoveArmToJoints_Result__fini(&msg->result);
}
...
alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__are_equal(const alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response * lhs, const alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response * rhs)
{
  ...
  // result
  if (!alicia_d_control_interfaces__action__MoveArmToJoints_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response * msg = (alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response *)allocator.allocate(sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response));
  bool success = alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__Sequence__init(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response * data = NULL;

  if (size) {
    data = (alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response *)allocator.zero_allocate(size, sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__Sequence__fini(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__Sequence * array = (alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__Sequence *)allocator.allocate(sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__Sequence__destroy(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__Sequence__are_equal(const alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__Sequence * lhs, const alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response * data =
      (alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!alicia_d_control_interfaces__action__MoveArmToJoints_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__init(alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__init(&msg->feedback)) {
    alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__fini(alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__fini(&msg->feedback);
}
...
alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__are_equal(const alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage * lhs, const alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!alicia_d_control_interfaces__action__MoveArmToJoints_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage * msg = (alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage *)allocator.allocate(sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage));
  bool success = alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__Sequence__init(alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage * data = NULL;

  if (size) {
    data = (alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage *)allocator.zero_allocate(size, sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__Sequence__fini(alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__Sequence * array = (alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__Sequence *)allocator.allocate(sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__Sequence__destroy(alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__Sequence__are_equal(const alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__Sequence * lhs, const alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage * data =
      (alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!alicia_d_control_interfaces__action__MoveArmToJoints_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
