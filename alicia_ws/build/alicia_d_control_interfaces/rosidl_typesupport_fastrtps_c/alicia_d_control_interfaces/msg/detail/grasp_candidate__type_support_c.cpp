...
#include "alicia_d_control_interfaces/msg/detail/grasp_candidate__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose__functions.h"  // grasp_pose
...
using _GraspCandidate__ros_msg_type = alicia_d_control_interfaces__msg__GraspCandidate;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _GraspCandidate__ros_msg_type * ros_message = static_cast<const _GraspCandidate__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _GraspCandidate__ros_msg_type * ros_message = static_cast<_GraspCandidate__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_alicia_d_control_interfaces__msg__GraspCandidate(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GraspCandidate__ros_msg_type * ros_message = static_cast<const _GraspCandidate__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GraspCandidate__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_alicia_d_control_interfaces__msg__GraspCandidate(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_alicia_d_control_interfaces
size_t max_serialized_size_alicia_d_control_interfaces__msg__GraspCandidate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = alicia_d_control_interfaces__msg__GraspCandidate;
    is_plain =
      (
...
static size_t _GraspCandidate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_alicia_d_control_interfaces__msg__GraspCandidate(
...
static message_type_support_callbacks_t __callbacks_GraspCandidate = {
...
static rosidl_message_type_support_t _GraspCandidate__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GraspCandidate,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, alicia_d_control_interfaces, msg, GraspCandidate)() {
  return &_GraspCandidate__type_support;
}
