...
def get_versioned_moveit_config(
    ...
    Args:
        ...
        debug_mode: Whether to enable verbose hardware parser diagnostics
        use_open_loop_state: Whether hardware state mirrors commands instead of real feedback
        feedback_timeout_s: Maximum age for hardware feedback before it is treated as invalid
    ...
    xacro_args = {
        ...
        'hw_debug_mode': str(debug_mode).lower(),
        'hw_use_open_loop_state': str(use_open_loop_state).lower(),
        'hw_gripper_type': gripper_type,  # Can be "auto", "50mm", or "100mm"
        'hw_default_speed_deg_s': str(speed_deg_s),
        'hw_feedback_timeout_s': str(feedback_timeout_s),
    }
