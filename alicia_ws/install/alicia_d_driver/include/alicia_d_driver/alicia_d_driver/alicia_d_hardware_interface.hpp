...
private:
  bool is_joint_feedback_valid(const JointState & joint_state, double now_seconds) const;
  bool is_gripper_feedback_valid(const std::optional<SelfCheckData> & self_check_data) const;
  void mirror_commands_to_state();
  ...
  bool warned_invalid_feedback_;
  bool warned_gripper_feedback_unavailable_;
  bool warned_overheat_;
};
